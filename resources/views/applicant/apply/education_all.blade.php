...
{{--                                </div>--}}
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        <label for="academiclevel" class="form-label">Course Category  </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        <label for="certificate" class="form-label">Upload Certificate in PDF Format.Ensure document is less than 2mbs</label>
